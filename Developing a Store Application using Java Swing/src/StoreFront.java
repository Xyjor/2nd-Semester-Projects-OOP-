...
public class StoreFront extends javax.swing.JFrame {
 ...
 // Create a list to store product names
    ...
    // Loop through the JTable rows and get product names (Column index 1)
    for (int i = 0; i < jTableProducts.getRowCount(); i++) {
        String productName = jTableProducts.getValueAt(i, 1).toString();
        productList.add(productName);
    }

    // Open the Transaction Frame and pass the product list
    Transaction transaction = new Transaction(productList);
